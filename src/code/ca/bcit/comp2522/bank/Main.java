...
public class Main {
    ...
    private static final String ACCOUNT_1 = "abc123";
    ...
    private static final String ACCOUNT_2 = "654321";
    ...
    private static final String ACCOUNT_3 = "frd123";
    ...
    private static final String ACCOUNT_4 = "chan789";
    ...
    public static void main(final String[] args){
        ...
        BankClient client1 = new BankClient(person1, ACC_OPEN_1, ACCOUNT_1);

        System.out.println("Bank Client details: " + client1.getDetails());

        BankAccount bank1 = new BankAccount(ACCOUNT_1, ACC_OPEN_1, ACC_CLOSE_1, person1, BALANCE_1);
        ...
        BankClient client2 = new BankClient(person2, ACC_OPEN_2, ACCOUNT_2);

        System.out.println("Bank Client details: " + client2.getDetails());

        BankAccount bank2 = new BankAccount(ACCOUNT_2, ACC_OPEN_2, person2, BALANCE_2);
        ...
        BankClient client3 = new BankClient(person3, ACC_OPEN_3, ACCOUNT_3);

        System.out.println("Bank Client details: " + client3.getDetails());

        BankAccount bank3 = new BankAccount(ACCOUNT_3, ACC_OPEN_3, ACC_CLOSE_3, person3, BALANCE_3);
        ...
        BankClient client4 = new BankClient(person4, ACC_OPEN_4, ACCOUNT_4);

        System.out.println("Bank Client details: " + client4.getDetails());

        BankAccount bank4 = new BankAccount(ACCOUNT_4, ACC_OPEN_4, person4, BALANCE_4);
